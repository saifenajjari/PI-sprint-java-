...
//       EMPLACEMENT.setText(AjouterPointCollectController.longitude);
 ...
 Parent root = FXMLLoader.load(getClass().getResource("/views/afficherE.fxml"));
 ...
 @FXML
    ...
    private void versmaps(ActionEvent event) throws IOException {
         Stage stage = (Stage) bp.getScene().getWindow();
                System.err.println("bbb2");
           Parent root=FXMLLoader.load(getClass().getClassLoader().getResource("views/AfficherE.fxml"));
       AnchorPane newLoadedPane = FXMLLoader.load(getClass().getResource("/views/AjouterPointCollect.fxml"));
				bp.getChildren().clear();
				bp.getChildren().add(newLoadedPane);
    }
