...
public class PDFCreator {
    private final static String[] HEADER_ARRAY = {"S.No.", "Nom", "Prenom", "Age"};
    ...
    public static void addContent(Document document, List<Enfant> dataObjList) throws DocumentException {
        Paragraph paragraph = new Paragraph();
        paragraph.setFont(NORMAL_FONT);
        createReportTable(paragraph, dataObjList);
        document.add(paragraph);
    }
    private static void createReportTable(Paragraph paragraph, List<Enfant> dataObjList)
    throws BadElementException {
        ...
        int count = 1;
        for(Enfant dataObject : dataObjList){
            addToTable(table, String.valueOf(count)+".");
            addToTable(table, dataObject.getNom());
            addToTable(table, dataObject.getPrenom());
            addToTable(table, dataObject.getAge()+"");
            count++;
        }
        paragraph.add(table);
    }
    ...
    public static void addTitlePage(Document document, String title) throws DocumentException {
        ...
        preface.add(new Phrase("Liste des Enafant inscrites: ", NORMAL_FONT));
