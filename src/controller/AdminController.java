...
public class AdminController implements Initializable {
    ...
    private void evenement(ActionEvent event) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("/views/afficherE.fxml"));
    ...
    private void restau(ActionEvent event) throws IOException {
         mainpane.getChildren().clear();
        Parent parent = FXMLLoader.load(getClass().getResource("/views/Resto.fxml"));
        mainpane.getChildren().add(parent);
    ...
    private void transport(ActionEvent event) throws IOException {
         mainpane.getChildren().clear();
        Parent parent = FXMLLoader.load(getClass().getResource("/views/Transport.fxml"));
        mainpane.getChildren().add(parent);
         mainpane.getStylesheets().add(getClass().getResource("/Style/bootstrap3.css").toExternalForm());
        mainpane.toFront();
    }
    ...
    private void club(ActionEvent event) throws IOException {
         mainpane.getChildren().clear();
        Parent parent = FXMLLoader.load(getClass().getResource("/views/GuideAdmin.fxml"));
        mainpane.getChildren().add(parent);
        mainpane.toFront();
    }
